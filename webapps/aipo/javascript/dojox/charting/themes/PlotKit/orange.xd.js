dojo._xdResourceLoaded({depends:[["provide","dojox.charting.themes.PlotKit.orange"],["require","dojox.charting.Theme"]],defineResource:function(A){if(!A._hasResource["dojox.charting.themes.PlotKit.orange"]){A._hasResource["dojox.charting.themes.PlotKit.orange"]=true;
A.provide("dojox.charting.themes.PlotKit.orange");
