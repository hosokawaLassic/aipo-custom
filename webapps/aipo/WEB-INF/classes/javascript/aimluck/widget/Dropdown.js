...
if(F.indexOf("chrome")>-1||(dojo.isFF&&(dojo.isFF>=3.6))){var D=this.dropDown.domNode.parentNode;
var E=D.style.top.replace("px","");
top_new=parseInt(E)+window.scrollY;
D.style.top=top_new+"px"
}},_toggleDropDown:function(){if(this.disabled){return 
}dijit.focus(this.popupStateNode);
var E=this.dropDown;
if(!E){return false
}if(!this._opened){if(E.href&&!E.isLoaded){var D=this;
