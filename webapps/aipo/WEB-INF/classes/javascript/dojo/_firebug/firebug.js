...
dojo.deprecated=function(F,E,H){var G="DEPRECATED: "+F;
if(E){G+=" "+E
}if(H){G+=" -- will be removed in version: "+H
}console.debug(G)
};
dojo.experimental=function(F,D){var E="EXPERIMENTAL: "+F+" -- APIs subject to change without notice.";
if(D){E+=" "+D
}console.debug(E)
};
