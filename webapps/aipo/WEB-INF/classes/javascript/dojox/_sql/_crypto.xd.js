dojo._xdResourceLoaded({depends:[["provide","dojox._sql._crypto"]],defineResource:function(dojo){if(!dojo._hasResource["dojox._sql._crypto"]){dojo._hasResource["dojox._sql._crypto"]=true;
